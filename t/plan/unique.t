...
# Span planning
my $query = $builder->unique($builder->term('baum'));
...
is($query->to_string, 'unique(baum)', 'Stringification');
is($query->plan_for($index)->to_string, "unique('baum')", 'Planned Stringification');
