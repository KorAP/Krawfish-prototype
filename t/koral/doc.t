...
is($doc->fields->to_string, "'docID'='doc-3';'license'='closed';'textLength'=8;'URI'=<data:application/x.korap-link,http://korap.ids-mannheim.de/instance/example>;'pubDate'=2018-04-07", 'Fields');

my $index = Krawfish::Index->new;

ok($doc = $doc->identify($index->dict), 'Turn terms into term_ids');

is($doc->fields->to_string(1), "#1=#2;#3=#4;#5=#6(8);#7=<data:application/x.korap-link,http://korap.ids-mannheim.de/instance/example>;#8=#9(2018-04-07)", 'Fields');
...
is($doc->to_string(1), q![#1=#2;#3=#4;#5=#6(8);#7=<data:application/x.korap-link,http://korap.ids-mannheim.de/instance/example>;#8=#9(2018-04-07)](0)<>[#13;14$1;16$3](1)< >[#18;19$3](2)<->[#20](3)< >[#21;22$4;23$4](4)< >[#26;27$5;16$8](5)< >[#28;29$6](6)< >[#18;30$8](7)<->[#31](8)<.>[##]!, 'Stringification');
