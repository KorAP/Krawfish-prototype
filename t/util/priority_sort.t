...
ok($sorter->insert(1,'Baum 1'), 'Added rank 0 (1)');
ok($sorter->insert(1,'Baum 2'), 'Added rank 0 (2)');
ok($sorter->insert(2,'Baum 3'), 'Added rank 1 (1)');
ok($sorter->insert(2,'Baum 4'), 'Added rank 1 (2)');
